...
#_____________________________ Homework 6.1 _____________________________
...
predicted<-predict(C50_class ,testing[,-1] , type="class" )
str(predicted)
print(length(predicted))
print(length(testing$Class))

#Confusion Matrix
conf_matrix <- table(C50=predicted,Actual=testing$Class)
print(conf_matrix)
...
c50_error_rate<-wrong/length(testing$Class!=predicted)
c50_error_rate
